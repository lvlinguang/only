        ...
        if (obj && event1 && event2 && Time1 && Time2 && func1) {
            ...
            obj.each(function () {
                ...
                target.bind(event1, function (e) {
                    ...
                    common.lazyObject = setTimeout(function () { func1(target); }, Time1);
                ...
                bind(event2, function (e) {
                    ...
                    if (func2) {
                        ...
                        common.lazyObject = setTimeout(function () { func2(target); }, Time2);
                    }
                });
            });
        }
...
function InitXguiTable(target, fixbar, columns, frozenHeader, rownumbers, checkbox) {
    ...
    function resize() {
        ...
        //padding值
        var padding = $(target).find(".xgui-datagrid-cell:eq(0)").outerWidth() - $(target).find(".xgui-datagrid-cell:eq(0)").width();
        ...
        for (var i = 0; i < columns.length; i++) {
            ...
            $(target).find("td[field=" + columns[i].field + "] .xgui-datagrid-cell").width(w);
        }
    }
}
...
$.extend($.fn.validatebox.defaults.rules, {
    ...
    checkaAtivityNumber: {
        validator: function (value, param, fuc) {
            ...
            //调用数值验证
            $.fn.validatebox.defaults.rules.Integer.validator(value, param, function (success) {
                ...
                if (!success) {
                    ...
                    //后台验证
                    xgui.Ajax("/Activity/GetNewActivieNumber", { ID: ID }, "json", true, function (o) {

                        if (o != null) {

                            //提示信息
                            target.message = '活动期数不能小于当前已完成的期数' + o.Number + "！";
        ...
        validator: function (value, param, fuc) {
            ...
            $.fn.validatebox.defaults.rules.Integer.validator(value, param, function (success) {
                ...
                if (!success) {
                    ...
                    ////商品分组
                    //var Group = $("#GroupID").combobox("getSelected");
