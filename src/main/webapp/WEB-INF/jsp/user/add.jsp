				...
				<form id="dlg-form" class="dlg-form2">
					...
					<div class="dlg-form2-item">
						<label class="dlg-form2-name"><i>*</i>用户角色</label> <span
							...
							name="permissions" /> <select class="xgui-combobox"
							required="true" mode="Static" id="roleId" name="roleId">
					...
					<div class="dlg-form2-item">
						<label class="dlg-form2-name"><i>*</i>用户名称</label> <span
							...
							class="xgui-validatebox" mode="Static" required="true"
							validtype="length[2,10]" placeholder="2~18个字符"
							emptymsg="请填写用户名称！" style="width: 346px;" />
						</span>
					</div>
					<div class="dlg-form2-item">
						<label class="dlg-form2-name"><i>*</i>帐号</label> <span
							class="dlg-form2-Info"> <input name="account"
							class="xgui-validatebox" mode="Static" required="true"
							validtype="length[2,18]" placeholder="2~18个字符,可使用中文、字母、数字、下划线"
							emptymsg="请填写帐号！" style="width: 346px;" />
						</span>
					</div>
					<div class="dlg-form2-item">
						<label class="dlg-form2-name"><i>*</i>密码</label> <span
							class="dlg-form2-Info"> <input name="password" type="password"
							class="xgui-validatebox" mode="Static" required="true"  validtype="length[6,20]"
							placeholder="6~20个字符,可使用字母、数字、下划线" emptymsg="请填写密码！"
							style="width: 346px;" />
						</span>
					</div>
					<div class="dlg-form2-item">
						<label class="dlg-form2-name">手机号码
						</label> <span class="dlg-form2-Info"> <input name="mobile"
							class="xgui-validatebox" mode="Static"
							validtype="phone" placeholder="只可使用数字" emptymsg="请填写手机号码！"
							style="width: 346px;" />
						</span>
					</div>
					<div class="dlg-form2-item">
