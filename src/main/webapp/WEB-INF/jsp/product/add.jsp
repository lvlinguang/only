...
<script type="text/javascript" src="${path}/content/plugins/ueditor/ueditor.config.js"></script>
<script type="text/javascript" src="${path}/content/plugins/ueditor/ueditor.all.js"></script>
<script type="text/javascript" src="${path}/content/plugins/ueditor/lang/zh-cn/zh-cn.js"></script>
					...
					<form id="dlg-form" class="dlg-form2">
						...
						<div class="dlg-form2-item">
							...
							<span class="dlg-form2-Info">
								<input type="hidden" name="BigPicture" id="BigPicture" />
								<input type="hidden" name="Thumbnail" id="Thumbnail" />
								<input name="ProductName" class="xgui-validatebox" mode="Static" required="true" validtype="checkCharLen[40]" placeholder="请填写商品名" emptymsg="请填写商品名！" style="width: 346px;" />
								<script>
						...
						<div class="dlg-form2-item">
							...
							<span class="dlg-form2-Info">
								<input name="Price" class="xgui-validatebox" mode="Static" required="true" validtype="Integer" placeholder="请填写商品价格" emptymsg="请填写商品价格！" style="width: 346px;" />
							</span>
						</div>
						<div class="dlg-form2-item">
							<label class="dlg-form2-name">
							...
							<span class="dlg-form2-Info">
								<input id="category1" mode="Static" required="true">
							</span>
						</div>
						<div class="dlg-form2-item">
							<label class="dlg-form2-name">
							...
							<span class="dlg-form2-Info">
								<input name="ArtNumber" class="xgui-validatebox" mode="Static" required="true" validtype="length[2,20]" placeholder="请填写商品货号" emptymsg="请填写商品货号！" style="width: 346px;" />
							</span>
						</div>
